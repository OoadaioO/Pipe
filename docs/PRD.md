...
- [Pipe 游戏产品需求文档 (PRD)](#pipe-游戏产品需求文档-prd)
  - [1. 产品概述](#1-产品概述)
    - [1.1 游戏概念](#11-游戏概念)
    - [1.2 核心玩法](#12-核心玩法)
    - [1.3 目标用户](#13-目标用户)
  - [2. 核心功能需求](#2-核心功能需求)
    - [2.1 游戏玩法](#21-游戏玩法)
      - [2.1.1 基础移动机制](#211-基础移动机制)
      - [2.1.2 输入系统](#212-输入系统)
      - [2.1.3 碰撞检测](#213-碰撞检测)
    - [2.2 管道系统](#22-管道系统)
      - [2.2.1 程序化生成](#221-程序化生成)
      - [2.2.2 管道配置](#222-管道配置)
    - [2.3 障碍物系统](#23-障碍物系统)
      - [2.3.1 障碍物生成](#231-障碍物生成)
      - [2.3.2 动态障碍物](#232-动态障碍物)
    - [2.4 玩家控制](#24-玩家控制)
      - [2.4.1 Player控制层](#241-player控制层)
      - [2.4.2 Avatar表现层](#242-avatar表现层)
    - [2.3 游戏模式](#23-游戏模式)
      - [2.3.1 无尽模式](#231-无尽模式)
    - [2.4 用户界面](#24-用户界面)
      - [2.4.1 主界面](#241-主界面)
      - [2.4.2 游戏内UI](#242-游戏内ui)
    - [2.5 UI系统](#25-ui系统)
      - [2.5.1 游戏内UI](#251-游戏内ui)
      - [2.5.2 游戏结束UI](#252-游戏结束ui)
    - [2.6 音频系统](#26-音频系统)
      - [2.6.1 背景音乐](#261-背景音乐)
      - [2.6.2 音效系统](#262-音效系统)
  - [3. 技术特性](#3-技术特性)
...
- **精确定位**: 通过IPlaceable接口实现障碍物在管道上的精确定位
